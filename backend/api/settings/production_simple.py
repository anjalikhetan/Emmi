...
# STATIC & MEDIA (Using local storage for now)
# ------------------------------------------------------------------------------
# We'll use local storage instead of S3 for the simplified deployment
STATIC_URL = "/static/"
MEDIA_URL = "/media/"

# EMAIL (Using console backend for now)
# ------------------------------------------------------------------------------
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Emmi Backend <noreply@emmi.app>",
)
